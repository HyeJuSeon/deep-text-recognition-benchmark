...
class EfficientNet(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, blocks_args=None, global_params=None):
    ...
    @classmethod
    def from_name(cls, in_channels, out_channels, model_name, **override_params):
        ...
        model = cls(in_channels, out_channels, blocks_args, global_params)
